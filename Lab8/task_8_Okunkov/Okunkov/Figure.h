...
//	void setupPath(){
//	//создаЄм вершинный массив и вершинный буфер
//	glGenVertexArrays(1, &vertexArray);//создаЄм вершинный массив
//	glGenBuffers(1, &vertexBuffer); // создаЄм вершинный буфер
//	glBindVertexArray(vertexArray);// делаем вершинный массив активным
//	//св¤зываем vertexBuffer с GL_ARRAY_BUFFER
//	glBindBuffer(GL_ARRAY_BUFFER, vertexBuffer);
//	// копируем содержимое vertices в вершинный буфер vertexBuffet
